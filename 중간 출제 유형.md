...
3. 품사 태깅(part-of-speech tagging): 단어에 품사 정보를 매핑하는 작업이며, 이 결과를 활용해 특정 품사의 단어를 불용어로 처리할 수 있음
4. 불용어(stop words): 문장 내에서 등장하는 빈도 때문에 성능에 영향을 미치므로 사전에 제거해 주어야 함 불용어 예로 "a", "the", "she", "he" 등이 있음 조사, 형용사, 부사 등 다 제거
5. 어간 추출(stemming): 단어를 기본 형태로 만드는 작업
